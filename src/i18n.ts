export const TEXT = {
  cn: {
    ...
    devices: {
      ...
      pair: "配对",
      repair: "重新配对",
      fileTransferTitle: "文件传输 (bate)",
      fileTransferCopy: "把文件拖到目标设备，MyKVM 会通过已配对的 QUIC 连接发送。（测试功能，可能不稳定）",
  ...
  en: {
    ...
    devices: {
      ...
      pair: "Pair",
      repair: "Re-pair",
      fileTransferTitle: "File Transfer (bate)",
      fileTransferCopy: "Drop files onto a target device to send them over the paired QUIC link. (Experimental, may be unstable)",
