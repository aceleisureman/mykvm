export const TEXT = {
  cn: {
    ...
    settings: {
      ...
      inputDebug: "输入调试",
      inputDebugStatus: "状态",
      inputDebugRoute: "最近路由",
      inputDebugFailure: "最近失败",
      inputDebugEvents: "最近事件",
      inputDebugEmpty: "暂无输入调试记录。",
      name: "名称",
      address: "地址",
      ports: "端口",
      peers: "发现设备",
    ...
    remoteFiles: {
      ...
      pullPartial: "拉取完成：{count} 个文件，共 {size}；{failed} 个文件失败。",
      pullFailed: "拉取失败。",
      modified: "修改于",
    ...
    devices: {
      ...
      fileTransferPartial:
        "部分完成：已发送 {count} 个文件到 {target}，共 {size}；{failed} 个文件失败。",
  ...
  en: {
    ...
    settings: {
      ...
      inputDebugStatus: "Status",
      inputDebugRoute: "Last Route",
      inputDebugFailure: "Latest Failure",
      inputDebugEvents: "Recent Events",
      inputDebugEmpty: "No input debug events yet.",
      name: "Name",
      address: "Address",
      ports: "Actual Ports",
      peers: "Peers",
      ...
      fileTransferCopy:
        "Drag files onto an adjacent screen to transfer them across devices.",
    ...
    logs: {
      ...
      subtitle: "View real-time logs for diagnosing connection and transport issues.",
    ...
    syncHistory: {
      title: "Sync History",
      subtitle: "Clipboard and file sync history records.",
      clipboard: "Clipboard",
      file: "File",
      sent: "Sent",
      received: "Received",
    ...
    remoteFiles: {
      ...
      pullPartial: "Pull complete: {count} file(s), {size} total; {failed} failed.",
    ...
    devices: {
      ...
      fileTransferPartial:
        "Partially complete: sent {count} file(s) to {target}, {size} total; {failed} failed.",
